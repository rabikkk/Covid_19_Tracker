 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /home/vestel/workspace_ccs/simple_broadcaster_CC26X2R1_LAUNCHXL_tirtos_ccs/Release/configPkg/package/cfg/simple_broadcaster_app_pem4f");
